...
const vi: Dict = {
  ...
  "plugins.dev-tools.description": "Chuyển CSV ↔ JSON và làm đẹp/rút gọn JSON — dán văn bản hoặc tải tệp lên.",
...
const en: Dict = {
  ...
  "plugins.dev-tools.description": "Convert CSV ↔ JSON and beautify/minify JSON — paste text or upload a file.",
  "dev.csv2json": "CSV → JSON",
  "dev.json2csv": "JSON → CSV",
